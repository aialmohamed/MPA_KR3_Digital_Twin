...
- [x] create an OPCUA Server
- [x] create a start Dashboard (Web?)
- [x] Test the interface with KR3 R540 (on other KR3 robots)
- [x] Create the software for the ROS2 controllers (if required)

...
namespace DigitalTwin.Models
{
    public class RobotPositionSimulation
    {
        ...
        private readonly double _movementThreshold = 1e-3; // Movement tolerance
        private readonly int _movementCheckIntervalMs = 100; // Check interval in milliseconds
        ...
        private double[] _lastPosition = new double[3]; // Last known position [X, Y, Z]
